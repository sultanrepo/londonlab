...
$selRef = $patient['referral_type'] ?? 'self';
            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    <div class="d-flex gap-3">
                        <label id="optDoctor" style="flex:1;border:2px solid <?= $selRef==='doctor'?'#1a6b4a':'#e2e8f0' ?>;border-radius:10px;padding:14px 18px;cursor:pointer;background:<?= $selRef==='doctor'?'#f0fdf4':'#fff' ?>;" onclick="setRef('doctor')">
                        ...
                        <label id="optSelf" style="flex:1;border:2px solid <?= $selRef==='self'?'#1a6b4a':'#e2e8f0' ?>;border-radius:10px;padding:14px 18px;cursor:pointer;background:<?= $selRef==='self'?'#f0fdf4':'#fff' ?>;" onclick="setRef('self')">
                ...
                <div class="col-12" id="selfSection" style="display:<?= $selRef==='self'?'block':'none' ?>;">
                    <div class="p-3 rounded-2" style="background:#f0fdf4;border:1px solid #bbf7d0;font-size:13px;">Walk-in — no commission deducted.</div>
                </div>
            </div>
